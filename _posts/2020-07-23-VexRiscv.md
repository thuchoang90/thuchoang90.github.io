...
for Briey SoC:      $ sbt "runMain vexriscv.demo.Briey"   #GenFull + bus + devices + IO
```
...
*(the generic OpenOCD tool in the [Initial Setup: II.g)](/tutorial/2020/07/23/Fresh-Ubuntu-setup#h-ii-g-openocd) won't work)*
```shell
